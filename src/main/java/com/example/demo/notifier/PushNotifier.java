...
public class PushNotifier {
    ...
    public NotificationResult notify(PushMessage message, String notificationId) {
        log.info("Sending push notification to device: {}", message.deviceToken());
        ...
        try {
            ...
            Request httpRequest =
                    new Request.Builder().url("http://localhost:8081/push/send").post(body).build();
