...
public class SmsNotifier {
    ...
    public NotificationResult notify(SmsMessage message, String notificationId) {
        log.info("Sending SMS notification to: {}", message.to());
        ...
        try {
            ...
            Request httpRequest =
                    new Request.Builder().url("http://localhost:8081/sms/send").post(body).build();
